...
namespace DigitalRuby.BowAndArrow
{
    ...
    public class BowScript : MonoBehaviour
    {
        ...
        private void FireArrow(bool fizzle)
        {
            ...
            currentArrow.GetComponent<Rigidbody2D>().linearVelocity =
                currentArrow.transform.GetChild(0).gameObject.GetComponent<Rigidbody2D>().linearVelocity = BowShaft.transform.rotation * new Vector2(-speed, 0.0f);
